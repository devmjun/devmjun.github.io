...
| Do | Don`t | 
| :--: | :--: |
| 표면을 찾을 수 없습니다. 옆으로 움직이거나 휴대 전화 위치를 변경하십시오 <br> 위치를 눌러 [배치할 객체의 이름]을 배치하십시오 <br> 더 많은 조명을 켜고 돌아 다니십시오 <br> 휴대 전화를 더 천천히 움직여 보십시오 | 비행기를 찾을 수 없습니다. 경로는 확인하세요 <br> 비행기를 두드려 정박시켜보세요. <br> 기능이 충분하지 않습니다. <br> 과도한 움직임이 감지 되었습니다. | <br>
