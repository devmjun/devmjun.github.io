...
- 빌드 머신은 로컬 머신보다 조금 느릴수 있습니다. 특히 <U>[KIF](https://github.com/kif-framework/KIF)</U>로 UI 테스트를 하는 경우 빌드 머신의 속도가 느려지므로 실제 장비에서 볼수없는 경쟁 조건이 있음을 의미하는 인스턴스로 실행할수 없습니다. 또는 로컬에서 볼수 없는 빌드 서버의 불편함을 테스트 할수 없습니다. 
